...
/*   Updated: 2020/09/20 15:25:40 by jelvan-d      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(FragTrap const& src) : ClapTrap(src._hitPoints, src._maxHitPoints, src._energyPoints, src._maxEnergyPoints, src._level, src._name, src._meleeDamage, src._rangedDamage, src._armor)
{
	*this = src;
	return ;
}
